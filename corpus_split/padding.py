...
def pad_and_save_wav_file(args):
    file, source_folder, target_folder, ref_folder = args
    ...
    sf.write(os.path.join(target_folder, f"{file_name}.wav"), x2_padded, fs)


def pad_wav_files(source_folder, target_folder, ref_folder):
    ...
    with multiprocessing.Pool(12) as pool:
        results = pool.imap(
            ...
            [(file, source_folder, target_folder, ref_folder) for file in wav_files]
        )
...
if __name__ == "__main__":
    ...
    target_folder = "../data/corpus/corpus-4-0-padded"
    ref_folder = "../data/corpus/corpus-0"
    pad_wav_files(source_folder, target_folder, ref_folder)