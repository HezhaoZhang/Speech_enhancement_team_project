...
with open(csv_file, 'r') as csvfile:
    ...
    for row in reader:
        ...
        if current_tuple not in unique_tuples:
...
corpus_ids = [3, 4]
channel_ids = [0, 3, 6, 9]
input_folders = [f'../data/corpus/corpus-{corpus_id}-{channel_id}' for corpus_id in corpus_ids for channel_id in channel_ids]
